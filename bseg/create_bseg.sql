...
-----------------------------------------------------
DROP TABLE SAP_BSEG_5200 IF EXISTS;
CREATE TABLE SAP_BSEG_5200
AS
SELECT 
  BUKRS AS SOCIEDAD,
  KOSTL AS CECO,
...
FROM INPUT_SAP_BSEG_5200
DISTRIBUTE ON RANDOM;
--ORGANIZAMOS EN BASE A CUENTAS Y FECHAS
ALTER TABLE SAP_BSEG_5200
ORGANIZE ON (CUENTA,FECHA_BASE);
-----------------------------------------------------
---------RECREAMOS BSEG EN BASE A LA TABLA MADRE-----
-----------------------------------------------------
DROP TABLE SAP_BSEG_5300 IF EXISTS;
CREATE TABLE SAP_BSEG_5300
AS
SELECT 
  BUKRS AS SOCIEDAD,
  KOSTL AS CECO,
  ...
  SHKZG AS TIPO_SALDO,
  BELNR AS NUMERO_DOCUMENTO
FROM INPUT_SAP_BSEG_5300
DISTRIBUTE ON RANDOM;
--ORGANIZAMOS EN BASE A CUENTAS Y FECHAS
ALTER TABLE SAP_BSEG_5300
ORGANIZE ON (CUENTA,FECHA_BASE);
-----------------------------------------------------
---------RECREAMOS BSEG EN BASE A LA TABLA MADRE-----
-----------------------------------------------------
DROP TABLE SAP_BSEG_5500 IF EXISTS;
CREATE TABLE SAP_BSEG_5500
AS
SELECT 
  BUKRS AS SOCIEDAD,
  KOSTL AS CECO,
  ...
  SHKZG AS TIPO_SALDO,
  BELNR AS NUMERO_DOCUMENTO
FROM INPUT_SAP_BSEG_5500
DISTRIBUTE ON RANDOM;
--ORGANIZAMOS EN BASE A CUENTAS Y FECHAS
ALTER TABLE SAP_BSEG_5500
ORGANIZE ON (CUENTA,FECHA_BASE);
