...
----------------------------------------------
INSERT INTO ESQUEMA_GRUPOS_1(INDICE,NODO,GRUPO)
...
----------------------------------------------
INSERT INTO ESQUEMA_GRUPOS_2(INDICE,NODO_GRUPO_1,NODO,GRUPO)
...
ALTER TABLE ESQUEMA_GRUPOS_2
ORGANIZE ON(NODO_GRUPO_1);

----------------------------------------------
------------ POBLAMOS TABLA GRUPOS 3 ---------
----------------------------------------------
INSERT INTO ESQUEMA_GRUPOS_3(INDICE,NODO_GRUPO_2,NODO,GRUPO)
...
--- ORGANIZAMOS EN BASE A LOS IDS PADRES ----
ALTER TABLE ESQUEMA_GRUPOS_3
ORGANIZE ON(NODO_GRUPO_2);

----------------------------------------------
------------ POBLAMOS TABLA GRUPOS 4 ---------
----------------------------------------------
INSERT INTO ESQUEMA_GRUPOS_4(INDICE,NODO_GRUPO_3,NODO,GRUPO)
...
--- ORGANIZAMOS EN BASE A LOS IDS PADRES ----
ALTER TABLE ESQUEMA_GRUPOS_4
ORGANIZE ON(NODO_GRUPO_3);

----------------------------------------------
------------ POBLAMOS TABLA GRUPOS 5 ---------
----------------------------------------------
INSERT INTO ESQUEMA_GRUPOS_5(INDICE,NODO_GRUPO_4,NODO,GRUPO)
...
--- ORGANIZAMOS EN BASE A LOS IDS PADRES ----
ALTER TABLE ESQUEMA_GRUPOS_5
ORGANIZE ON(NODO_GRUPO_4);

----------------------------------------------
------------ POBLAMOS TABLA GRUPOS 6 ---------
----------------------------------------------
INSERT INTO ESQUEMA_GRUPOS_6(INDICE,NODO_GRUPO_5,NODO,GRUPO)
...
--- ORGANIZAMOS EN BASE A LOS IDS PADRES ----
ALTER TABLE ESQUEMA_GRUPOS_6
ORGANIZE ON(NODO_GRUPO_5);

----------------------------------------------
------------ POBLAMOS TABLA GRUPOS 7 ---------
----------------------------------------------
INSERT INTO ESQUEMA_GRUPOS_7(INDICE,NODO_GRUPO_6,NODO,GRUPO)
...
--- ORGANIZAMOS EN BASE A LOS IDS PADRES ----
ALTER TABLE ESQUEMA_GRUPOS_7
ORGANIZE ON(NODO_GRUPO_6);

----------------------------------------------
------------ POBLAMOS TABLA GRUPOS 8 ---------
----------------------------------------------
INSERT INTO ESQUEMA_GRUPOS_8(INDICE,NODO_GRUPO_7,NODO,GRUPO)
